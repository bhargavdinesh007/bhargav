...
<%@ page import="java.sql.*" %>
        ...
        %>
           ...
           <div id='cssmenu'>
            <ul>
             <li ><a href='http://localhost:8084/indiatours/home.jsp'><span>Home</span></a></li>
             
             <li><a href='http://localhost:8084/indiatours/best_value_tour.jsp'><span>Best Value Tours</span></a></li>
             <li><a href='http://localhost:8084/indiatours/hotel.jsp'><span>Hotels</span></a></li>
             <li><a href='http://localhost:8084/indiatours/destination_information.jsp'><span>Destination Information</span></a></li>
             <li><a href='http://localhost:8084/indiatours/book_your_own_tour.jsp'><span>Book Your Own Tour</span></a></li>
             <li class='last'><a href='http://localhost:8084/indiatours/contact_us.jsp'><span>Contact US</span></a></li>
             <li><a href='http://localhost:8084/indiatours/aboutus.jsp'><span>About Us</span></a></li>
             <li><a href='posthotel.jsp'><span>Share your Hotel with Us</span></a></li>
            </ul>
            </div>
